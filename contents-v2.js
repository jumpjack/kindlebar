...
function replaceDivWithCanvas() {
  const div = document.querySelector('ion-footer[item-i-d="reader-footer"]');
  if (div) {
...
// Ottimizzazione: usa MutationObserver invece di setInterval
//const observer = new MutationObserver(replaceDivWithCanvas);
